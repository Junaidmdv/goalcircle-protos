...
func (x *PlayerProfileRes) GetPlayerId() string {
	if x != nil {
		return x.PlayerId
	}
	return ""
...
func (x *PlayerProfileRes) GetPosition() string {
	if x != nil {
		return x.Position
	}
	return ""
...
const file_team_service_proto_rawDesc = "" +
	...
	"\tfull_name\x18\x03 \x01(\tR\bfullName\x12>\n" +
	"\rdate_of_birth\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vdateOfBirth\x12\x1a\n" +
	"\bposition\x18\x05 \x01(\tR\bposition\x12 \n" +
...
var file_team_service_proto_depIdxs = []int32{
	...
	95, // 30: team.PlayerProfileRes.created_at:type_name -> google.protobuf.Timestamp
